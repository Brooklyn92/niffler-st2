...
public class UsersGroupExtension implements
        BeforeEachCallback,
        AfterTestExecutionCallback,
        ParameterResolver {

    public static Namespace USER_EXTENSION_NAMESPACE = Namespace.create(UsersGroupExtension.class);
    ...
    public void afterTestExecution(ExtensionContext context) throws Exception {
        ...
        for (Map.Entry<UserJson, UserType> user : users.entrySet()) {
